...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border border-pallette-600 bg-transparent px-3 text-sm font-medium ring-offset-pallette-100 transition-colors hover:bg-pallette-300 focus:outline-none focus:ring-2 focus:ring-pallette-600 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 group-[.destructive]:border-gray-100/40 group-[.destructive]:hover:border-red-500/30 group-[.destructive]:hover:bg-red-500 group-[.destructive]:hover:text-gray-50 group-[.destructive]:focus:ring-red-500 dark:border-gray-800 dark:ring-offset-gray-950 dark:hover:bg-gray-800 dark:focus:ring-gray-300 dark:group-[.destructive]:border-gray-800/40 dark:group-[.destructive]:hover:border-red-900/30 dark:group-[.destructive]:hover:bg-red-900 dark:group-[.destructive]:hover:text-gray-50 dark:group-[.destructive]:focus:ring-red-900",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-pallette-600 opacity-0 transition-opacity hover:text-pallette-600 focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.destructive]:text-pallette-300 group-[.destructive]:hover:text-pallette-300 group-[.destructive]:focus:ring-pallette-300 group-[.destructive]:focus:ring-offset-pallette-500 dark:text-gray-50/50 dark:hover:text-gray-50",
      className,
    )}
    toast-close=""
    {...props}

  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      <div className="max-w-5xl p-4 text-center">
        <h1 className="mb-8 text-6xl font-normal text-pallette-600">
          About KanDo
        </h1>
        <p className="mb-12 text-balance text-2xl font-semibold text-pallette-600">
        ...
        <h2 className="mb-8 text-4xl font-semibold text-pallette-600">
          Our Mission{" "}
        </h2>
        <p className="mb-12 text-balance text-2xl font-semibold text-pallette-600">
        ...
        <ul className="mb-12 list-inside list-disc text-center text-2xl font-semibold text-pallette-600">
          <li>

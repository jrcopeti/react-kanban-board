...
function ColumnContainer() {
  ...
  return (
    ...
    >
      <section className="flex h-[60px] cursor-grab items-center justify-between rounded-lg border-4 border-pallette-100 bg-pallette-500 p-3 text-xl font-semibold text-pallette-100 dark:border-blue-100 dark:bg-slate-800 dark:text-blue-100">
      ...
      <Button
        ...
        className="flex h-[60px] cursor-grab items-center gap-2 rounded-lg border-4 border-pallette-100 bg-pallette-500 p-3 text-xl font-semibold text-pallette-100 hover:bg-pallette-600 dark:border-blue-100 dark:bg-slate-800 dark:text-blue-100 dark:hover:bg-rose-950"
      >

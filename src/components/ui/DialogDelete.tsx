...
function DialogDelete({
  ...
  const taskClassName =
    "absolute bottom-1 right-5 z-30 text-pallette-500 dark:text-slate-500 translate-x-1/2 bg-transparent dark:bg-transparent hover:bg-pallette-200 p-1.5";
      ...
      <DialogTrigger asChild>
        ...
        >
          <MdOutlineDeleteOutline
            className="opacity-100 hover:text-pallette-100 hover:opacity-65 dark:hover:text-slate-500"
            size={20}
          />
        </Button>
      </DialogTrigger>
